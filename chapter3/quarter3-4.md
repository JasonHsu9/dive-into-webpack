...
![](http://union-click.jd.com/jdc?d=MDHQeE) 
...
由于需要把 SCSS 源代码转换成 CSS 代码，在[1-4 使用Loader](../chapter1/quarter1-4.html)中曾介绍过转换文件最适合的方式是使用 Loader，Webpack 官方提供了对应的 [sass-loader](https://github.com/webpack-contrib/sass-loader)。
...
3.  style-loader 会把 CSS 代码转换成字符串后，注入到 JavaScript 代码中去，通过 JavaScript 去给 DOM 增加样式。如果你想把 CSS 代码提取到一个单独的文件而不是和 JavaScript 混在一起，可以使用[1-5 使用Plugin](../chapter1/quarter1-5.html) 中介绍过的 ExtractTextPlugin。
...
> 本实例[提供项目完整代码](../projectDemo/3-4使用SCSS语言.zip)
