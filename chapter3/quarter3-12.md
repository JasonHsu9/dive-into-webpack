...
![3-12electron-arch](../image/3-12electron-arch.png)
...
由于 Electron 应用中的每一个窗口对应一个网页，所以需要开发2个网页，分别是主窗口的 `index.html`和新打开的窗口 `login.html`。 也就是说项目由2个单页应用组成，这和[3-10管理多个单页应用](./quarter3-10.html) 中的项目非常相似，让我们来把它改造成一个 Electron 应用。
...
这句配置曾在[2-7其它配置项-Target](../chapter2/quarter2-7.html#Target)中提到，意思是指让 Webpack 构建出用于 Electron 渲染进程用的 JavaScript 代码，也就是这2个窗口需要的网页代码。
...
![3-12electron-app](../image/3-12electron-app.png)

> 本实例[提供项目完整代码](../projectDemo/3-12构建Electron应用.zip)
