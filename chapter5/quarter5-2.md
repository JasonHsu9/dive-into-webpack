...
先来看看由 [1-3安装与使用](../chapter1/quarter1-3.html) 中最简单的项目构建出的 `bundle.js` 文件内容，代码如下：
...
在采用了 [4-12 按需加载](../chapter4/quarter4-12.html) 中介绍过的优化方法时，Webpack 的输出文件会发生变化。
...
> 本实例[提供项目完整代码](../projectDemo/5-2输出文件分析.zip)
